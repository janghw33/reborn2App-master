...
import Results from "@/layout/aside/search/Results.vue";
import Main from "@/layout/aside/search/Main.vue";
import Empty from "@/layout/aside/search/Empty.vue";
import AdvancedOptions from "@/layout/aside/search/AdvancedOptions.vue";
import Preferences from "@/layout/aside/search/Preferences.vue";
import InlineForm from "@/layout/aside/search/InlineForm.vue";
