    ...
    setup() {
      ...
      const popupContext: PopupContext = {
        ...
        header: [
          ...
          { name: "차번", key: "acdntReprtSn", sortable: true },
          { name: "운전자", key: "mycarDrverNm", width: 200, sortable: true },
          { name: "사고자", key: "acdntSeCodeTxt", width: 150, sortable: true },
          { name: "사고장소", key: "acdntPlcCodeTxt", width: 150, sortable: true },
          { name: "사고종별", key: "acdntKndCodeTxt", width: 150, sortable: true },
          { name: "사고원인", key: "acdntCauseCodeTxt", width: 200, sortable: true },
          { name: "사고유형", key: "acdntTyCodeTxt", width: 100, sortable: true },
          { name: "일반", key: "acdntProcessMth1", width: 100, sortable: true },
          { name: "상대방", key: "acdntProcessMth2", width: 100, sortable: true },
          { name: "자차", key: "mycarInsrncSbscrbYn", width: 100, sortable: true },
          { name: "완결", key: "comptYn", width: 100, sortable: true },
          ...
          { name: "계약", key: "cnctNo", width: 100, sortable: true },
        ],
        itemBinding(row) {
