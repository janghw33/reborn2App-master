...
<script lang = "ts" setup>
  ...
  const listContext = reactive<IListContext>({
    listData: [],
    headers: [
      { name: "거래서 일련번호", key: "vhcleManageBcncSn", width: 200, sortable: true},
      { name: "거래처 명", key: "vhcleManageBcncNm", width: 200, sortable: true},
      { name: "거래처 구분", key: "vhcleManageBcncSeCode", width: 200, sortable: true},
      { name: "사용여부", key: "useYn" }
    ],
    perPage: 17,
    search: {
