...
<template>
  ...
  <BasePage :pageContext="pageContext">
    <BaseList :listContext="listContext">
      <!-- <template :dataSource="models.insrncList" v-slot:cell-gnrlInsrnSn="{row}">
        <el-option :value="row.insrncKndSn" :label="row.insrncKndNm"></el-option>
      </template> -->
      <template v-slot:cell-insrnc>
