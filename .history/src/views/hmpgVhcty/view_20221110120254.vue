        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="card-body pt-2 pb-2" style="padding: 0px 16px"></div>
              <FormItem label="판매여부" :required="true" name="sleYn">
                ...
                <FormItem label="일반보험매핑" :required="true" name="prfectInsrncSn">
                ...
                <FormItem label="프리미엄 여부" :required="true" name="deskNm">
                  <Input type="checkBox" v-model="formContext.formData.expsrGradCode"></Input>
                </FormItem>
            </div>
