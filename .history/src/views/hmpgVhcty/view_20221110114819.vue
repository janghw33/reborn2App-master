      ...
      <div class="card">
        <div class="row">
          ...
          <div class="col-6">
            ...
            <FormItem label="판매여부" :required="true" name="sleYnTxt">
                <Input type="text" v-model="formContext.formData.sleYnTxt"></Input>
              </FormItem>
              <FormItem label="일반보험매핑" :required="true" name="gnrlInsrncSn">
