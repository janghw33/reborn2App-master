...
<script lang="ts" setup>
  ...
  const listContext = reactive<IListContext>({
    listData: [],
    headers: [
      { name: "카테고리", key: "ctgryCode", width: 120, sortable: true },
      { name: "제목", key: "bbscttTitle", width: 200, sortable: true },
      { name: "내용", key: "bbscttContents", sortable: true },
      { name: "작성자", key: "wrterNm", width: 100, sortable: true },
      { name: "작성시간", key: "frstRegistDt", width: 200, sortable: true },
    ],
    perPage: 17,
    search: {
      types: [],
