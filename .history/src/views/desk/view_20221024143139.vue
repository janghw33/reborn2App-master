...
<template>
  <BasePage :pageContext="pageContext">
    <BaseForm :formContext="formContext">
      <div class="col-8">
      <FormItem label="데스크명 명" :required="true" name="paySeContents">
        <Input name="deskNm" type="text" v-model="formContext.formData.paySeContents"></Input>
      </FormItem>
    </div>
      <div class ="row">
        <RebornControl
        ...
        :required="true"
        name="deskNm"
        v-model="formContext.formData.deskNm">
      </RebornControl>
    </div>
    </BaseForm>
  </BasePage>
