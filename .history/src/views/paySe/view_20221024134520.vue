  ...
  <BaseForm :formContext="formContext">
    <div class="col-5">
      <FormItem label="입금방법 명" :required="true" name="paySeContents">
        <Input name = "paySeContents" type="text" v-model="formContext.formData.paySeContents" >
        </Input>
      </FormItem>
    </div>
    ...
    <div class="col-5">
      <FormItem label="사용하지 않음" :required="true" name="paySeContents">
        <Input type="checkbox" v-model="formContext.formData.useYn" true-value="Y" false-value="N">
        </Input>
      </FormItem>
    </div>

    <div class="col-2">
      <FormItem label="키오스크 결제 여부" :required="true" name="paySeContents" labelWidth="20px">
        <Input type="checkbox" v-model="formContext.formData.kioskPayYn" true-value="Y" false-value="N">
        </Input>
      </FormItem>
    </div>
