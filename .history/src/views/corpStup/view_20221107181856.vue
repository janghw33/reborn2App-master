    ...
    <BaseForm :formContext="formContext">
      ...
      <div class="card" style="width: 1000px ;">
        <div class="card-body">
            ...
            <el-row>
              <FormItem name="bsnmNo" :required="true" label="사업자 번호">
                <Input type="text" v-model="formContext.formData.bsnmNo"></Input>
              </FormItem>
              <FormItem name="corpNm" :required="true" label="상호" :style = "padding=">
                <Input type="text" v-model="formContext.formData.corpNm"></Input>
              </FormItem>
            </el-row>
