    ...
    <BaseForm :formContext="formContext">
      <div class="card" >
        <div class="card-body">
          <div class="row">
            <div class="col-3">
              <FormItem label="사업자번호" :required="true">
                <Input type="text" v-model="formContext.formData.bsnmNo"></Input>
              </FormItem>
            </div>
            <div class="col-3" >
              <FormItem label="상호" :required="true" >
          ...
          <div class="row">
          <div class="col-3">
            <FormItem label="대표자명" :required="true">
          ...
          <div class="col">
            <FormItem label="휴일설정" >
              <Input label="월" type="checkbox" id="monday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="화" type="checkbox" id="tuesday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="수" type="checkbox" id="wednesay" v-model="formContext.formData.holidayCode"></Input>
              <Input label="목" type="checkbox" id="thursday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="금" type="checkbox" id="friday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="토" type="checkbox" id="saturday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="일" type="checkbox" id="sunday" v-model="formContext.formData.holidayCode"></Input>
              <Input label="공휴일" type="checkbox" id="holiday" v-model="formContext.formData.holidayCode"></Input>
            </FormItem>
          </div>
            <div class="col-6">
