...
<template>
  <BaseForm :formContext="formContext">
    ...
    <div class="col-4">
      <FormItem label="생년월일" :required="true" name="chauferDrverBrthdy" placeholder="yyyy-MM-dd">
        <Input type="text" v-model="formContext.formData.chauferDrverBrthdy"></Input>
      </FormItem>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-4">
      <FormItem label="유효일자" :required="true" name="chauferDrverLcnsValidDe" placeholder="yyyy-MM-dd">
        <Input type="text" v-model="formContext.formData.chauferDrverLcnsValidDe"></Input>
      </FormItem>
    </div>
  </div>
    <div class="col-6">
