...
<template>
  ...
  <div class="row">
    ...
    <div class="col-4">
      <FormItem label = "쇼퍼운전자" label-width="15rem" name=" ineerEmpYn"></FormItem>
      <Input type="checkbox" v-model="formContext.formData.ineerEmpYn" true-value="Y" false-value="N"></Input>
    </div>
    <div class="col-4">
