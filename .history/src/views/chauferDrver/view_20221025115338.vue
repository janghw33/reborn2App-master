...
<template>
  <BaseForm :formContext="formContext">
    ...
    <div class="col-4">
      <FormItem label = "쇼퍼운전자" label-width="12rem" name=" innerEmpYn"></FormItem>
  ...
  <div calss="row">
    ...
    <div class="col-4">
      <FormItem label="유효일자" :required="true" name="chauferDrverBrthdy">
        <Input type="date" v-model="formContext.formData.chauferDrverBrthdy"></Input>
      </FormItem>
    </div>
  </div>
    <div class="col-4">
      <FormItem label="면허 종류" :required="true" name="chauferDrverBrthdy">
        <Input type="radio" groupCode="SYSM011"  v-model="formContext.formData.chauferDrverBrthdy"></Input>
      </FormItem>
    </div>
  <div class="col-3">
     <FormItem label="우편번호">
