...
<template>
  ...
  <div class = "row">
    <div class="col-3">
      <FormItem label = "쇼퍼운전자" :required="true" name="chauferDrverNm"></FormItem>
      <Input label = "쇼퍼운전자" type="checkbox" v-model="formContext.formData.innerEmpYn" true-value="Y" false-value="N"></Input>
      <FormItem label = "운전자명" :required="true" name="chauferDrverNm"></FormItem>
    </div>
    <div class="col-4">
