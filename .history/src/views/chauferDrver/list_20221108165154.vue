...
const listContext = reactive<IListContext>({
  listData: [],
  headers: [
    { name: '운전자 코드', key: 'chauferDrverSn', width: 200, sortable: true },
    { name: '운전자명', key: 'chauferDrverNm', width: 200, sortable: true },
    { name: '구분', key: 'innerEmpYnTxt', width: 200, sortable: true},
    { name: '생년월일', key: 'chauferDrverBrthdy', width: 200, sortable: true },
    { name: '비고', key: 'etcContents', sortable: true },
    { name: '사용여부', key: 'useYnTxt', width: 120, sortable: true },
  ],
  perPage: 17,
  search: {
    types: [],
