...
<template>
  ...
  <div class="row">
    ...
    <div class="col-1">
      <RebornControl type="checkbox" label="사용하지 않음" v-model="formContext.formData.useYn" true-value="N" false-value="Y"></RebornControl>
    </div>
  </div>
  <div class="row">
    <div class="col-4">
...
<script lang="ts" setup>
  ...
  import BaseFormControl from '@/components/reborn/control/BaseFormControl.vue'
