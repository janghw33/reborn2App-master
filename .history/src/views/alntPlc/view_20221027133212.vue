  ...
  <BaseForm :formContext="formContext">
    ...
    <div class="col-6">
        <FormItem label="지역" :required="true" name="areaSeCodeTxt">
          <Input type="select" :dataSource="models.areaSeCodeTxt" v-model="formContext.formData.areaSeCodeTxt" groupCode="CUST019"></Input>
        </FormItem>
      </div>
      <!-- jhwTodo 차고지 리스트 불러오기 구현필요-->
      <div class="col-6">
        <FormItem label="차고지" :required="true" name="garageNm">
          <Input type="select" :dataSource="models.garageNmList" v-model="formContext.formData.garageNm" ></Input>
        </FormItem>
      </div>
      <div class = "col-4">
