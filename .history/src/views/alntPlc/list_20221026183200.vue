  ...
  const listContext = reactive<IListContext>({
    ...
    reSearch(searchFIlter: ISearchFilter) {
      listContext.listData = models.data.filter(f => {
        return (f.alorrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr)
      })
    }
  })
