    ...
    <div class="col-6">
      ...
      <div class="col-6">
        <FormItem label="차고지" :required="true" name="garageNm">
          <Input type="select" :dataSource="models.garageRows" v-model="formContext.formData.garageNm" v-slot="{ item }">
            <el-option :value="item.lendChrgeClSn" :label="item.garageNm"></el-option>
          </Input>
        </FormItem>
      </div>
      <div class = "col-4">
