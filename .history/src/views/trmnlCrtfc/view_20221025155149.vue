...
<template>
  <BaseForm :formContext="formContext">
    ...
    <div class ="col-8">
      ...
      <FormItem label="사용 여부" :required="true" name="trmnlDcContents">
        <Input type="checkbox" v-model="formContext.formData.etcContents"></Input>
      </FormItem>
    </div>
    ...
    <template v-slot:body="{ action }">
      ...
      <div class="row">
        ...
        <div class="mb-10 col-6">
          <RebornControl name="useYn" type="checkbox v-model="pageData.data.useYn" label="사용 여부" :dataSource="{Y: '사용', N: '미사용'}">
          </RebornControl>
        </div>
      </div>
    </template>
