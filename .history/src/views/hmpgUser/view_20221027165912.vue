...
<script lang="ts" setup>
  ...
  import BasePage, { IPageContext } from '@/components/reborn/BasePrint.vue'
  import FormItem from '@/components/rebonr.Input.vue'
  import Input from '@/components/reborn/FormItem.vue'
