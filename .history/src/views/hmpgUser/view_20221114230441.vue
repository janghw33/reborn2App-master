...
<<<<<<< HEAD
        ...
        <el-button type="button" v-on:click="formContext.formData.visible = true">비밀번호 수정</el-button>
...
=======
        ...
        <div class="col-6">
          <FormItem label="비밀번호 수정" name="passwordNew">
            <Input type="password" :required="true" v-model="formContext.formData.passwordNew"></Input>
          </FormItem>
          <FormItem label="비밀번호 재확인 " name="passwordNew">
            <Input type="password" :required="true" v-model="formContext.formData.passwordNew"></Input>
>>>>>>> 6c3d79782ea5bf270697c574d56b5cd77aa62a30
          </FormItem>
        </div>  
        <div class="col-6">
