      ...
      <div class="col-6">
        ...
        <div class="col-6">
          ...
          <FormItem label="비밀번호 확인" name=" passwordCheck">
            <el-input type=" password" v-model="formContext.formData.passwordCheck" @blur="methods.passwordCheckValid"></el-input>
...
<script lang="ts" setup>
  ...
  updateClick(row) {
    ...
    const methods = {
       passwordCheckValid() {
        if (formContext.formData.passwordNew !== this.passwordCheck) {
