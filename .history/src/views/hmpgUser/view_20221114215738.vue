    ...
    <BaseForm :formContext="formContext">
      ...
      <div class="col-6">
        ...
        <div class="col-6">
          ...
          <!-- <FormItem label="비밀번호 확인" name=" passwordNew" @blur="methods.passwordCheckValid">
          ...
          <!-- <input v-model="formContext.formData.passwordCheck" type="password" maxlength="16" @blur= "methods.passwordCheckValid">
        <div v-if="!formContext.formData.passwordCheckFlag">
          비밀번호가 동일하지 않습니다.
        </div> -->

        <input v-model="formContext.formData.passwordCheck" type="password" maxlength="16" @blur= "methods.passwordChecker">
        <div v-if="!formContext.formData.passwordCheckFlag">
          비밀번호가 동일하지 않습니다.
        </div>
