...
<template>
    <BaseForm :formContext="formContext">
      <div class="col-6">
        ...
        <el-button style="margin-bottom: 20px; margin-left: 120px;" type="button" v-on:click="formContext.formData.visible = true">비밀번호 수정</el-button>
        ...
        <div class="col-6">
          <FormItem label="생년월일" name="userBrthdy" :required="true" >
            <Input type="text" pattern="yyyy-MM-DD" v-model="formContext.formData.userBrthdy" ></Input>
          </FormItem>
        </div>
        <div class="col-6">
