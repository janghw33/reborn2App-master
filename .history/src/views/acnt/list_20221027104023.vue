...
<script lang="ts" setup>
  ...
  const listContext = reactive<IListContext>({
    listData: [],
    headers: [
      { name: "은행계좌 코드", key: "acntSn", width: 80, sortable: true },
      { name: "은행명", key: "acntBankNm", width: 80, sortable: true },
      { name: "계좌번호", key: "acntNo", width: 120, sortable: true },
      { name: "예금주", key: "acntDpstrNm", width: 120, sortable: true },
      { name: "비고", key: "etcContents", width: 40, sortable: true },
