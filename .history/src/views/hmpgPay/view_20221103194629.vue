            ...
            <div class="col-4">
              <div class="card shadow mb-2">
                <div class="card-body pt-2 pb-2" style="padding: 0px 16px" >
                  ...
                  <FormItem label="시작일자" name="resveBeginDe" :readonly="true">
                    <Input type="date" v-model ="formContext.formData.resveBeginDe" :readonly="true"></Input>
                    <Input type="time" v-model ="formContext.formData.resveBeginTime" :readonly="true"></Input>
                  </FormItem>
                  <FormItem label="종료일자" name="resveEndTime">
                    <Input type="date" v-model ="formContext.formData.resveEndDe" :readonly="true"></Input>
                    <Input type="time" v-model ="formContext.formData.resveEndTime" :readonly="true"></Input>
                  </FormItem>  
                </div>
                ...
                <div class="card-body pt-2 pb-2" style="padding: 0px 16px">
                  ...
                  <FormItem label="운전자 생년월일" name="drverBrthdy">
                    <Input type="date" v-model="formContext.formData.drverBrthdy" :readonly="true"></Input>
                  </FormItem>
                  <FormItem label="운전자 면허" name="drverLcnsKndCode" >
                    <Input type="radio"  v-model ="formContext.formData.drverLcnsKndCode" group-code="SYSM009"></Input>
                  </FormItem>
                </div>
              </div>
            </div>
