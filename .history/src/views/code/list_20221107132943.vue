          ...
          <div class="card  car-flush">
            <div class="card-body" style="padding: 10px 20px">
              ...
              <table class="table align-middle table-row-dashed fs-6 dataTable no-footer" style="cursor:pointer">
                <tr v-for="codeList in models.codeList" :key="codeList" :class="{'active': codeList.groupCode == models.codeList.groupCode }">
                  <td class="fw-bolde text-gray-800 text-center" @click="selectGroupCode(codeList.groupCode)">
