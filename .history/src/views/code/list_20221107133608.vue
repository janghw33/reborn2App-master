          ...
          <div class="card  car-flush">
            <div class="card-body" style="padding: 10px 20px">
              ...
              <table class="table align-middle table-row-dashed fs-6 dataTable no-footer" style="cursor:pointer">
                <tr v-for="codeInfo in models.codeList" :key="codeInfo" :class="{'active': codeInfo.codeNm == models.codeList.codeNm }">
                  <td class="fw-bolde text-gray-800 text-center" @click="selectGroupCode(codeInfo.code)">
